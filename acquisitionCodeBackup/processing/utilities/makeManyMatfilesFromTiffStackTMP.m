...
function template = makeManyMatfilesFromTiffStackTMP(trialfolder,savePath,experimentName,chunkSize,zeroThreshold,timeToExclude,cropping,template)
if ismac
...
for k=1:nChunks
    ...
    save([savePath,filename],'R','template','cropping','-v7.3')
