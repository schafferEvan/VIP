function varargout = SCAPE_quickview_VV(varargin)
% SCAPE_QUICKVIEW_VV MATLAB code for SCAPE_quickview_VV.fig
%      SCAPE_QUICKVIEW_VV, by itself, creates a new SCAPE_QUICKVIEW_VV or raises the existing
%      singleton*.
%
%      H = SCAPE_QUICKVIEW_VV returns the handle to a new SCAPE_QUICKVIEW_VV or the handle to
%      the existing singleton*.
%
%      SCAPE_QUICKVIEW_VV('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SCAPE_QUICKVIEW_VV.M with the given input arguments.
%
%      SCAPE_QUICKVIEW_VV('Property','Value',...) creates a new SCAPE_QUICKVIEW_VV or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SCAPE_quickview_VV_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SCAPE_quickview_VV_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SCAPE_quickview_VV

% Last Modified by GUIDE v2.5 04-Dec-2017 15:20:34

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SCAPE_quickview_VV_OpeningFcn, ...
                   'gui_OutputFcn',  @SCAPE_quickview_VV_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SCAPE_quickview_VV is made visible.
function SCAPE_quickview_VV_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SCAPE_quickview_VV (see VARARGIN)

% Choose default command line output for SCAPE_quickview_VV
...
% UIWAIT makes SCAPE_quickview_VV wait for user response (see UIRESUME)
% uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = SCAPE_quickview_VV_OutputFcn(hObject, eventdata, handles) 
