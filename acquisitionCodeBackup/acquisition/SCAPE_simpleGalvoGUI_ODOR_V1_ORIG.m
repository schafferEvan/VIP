function varargout = SCAPE_simpleGalvoGUI_ODOR_V1(varargin)
% SCAPE_SIMPLEGALVOGUI_ODOR_V1 MATLAB code for SCAPE_simpleGalvoGUI_ODOR_V1.fig
%      SCAPE_SIMPLEGALVOGUI_ODOR_V1, by itself, creates a new SCAPE_SIMPLEGALVOGUI_ODOR_V1 or raises the existing
%      singleton*.
%
%      H = SCAP194/1.57E2_GALVO_GUI_V15 returns the handle to a new SCAPE_SIMPLEGALVOGUI_ODOR_V1 or the handle to
%      the existing singleton*.
%
%      SCAPE_SIMPLEGALVOGUI_ODOR_V1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SCAPE_SIMPLEGALVOGUI_ODOR_V1.M with the given input arguments.
%
%      SCAPE_SIMPLEGALVOGUI_ODOR_V1('Property','Value',...) creates a new SCAPE_SIMPLEGALVOGUI_ODOR_V1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SCAPE_simpleGalvoGUI_ODOR_V1_OpeningFcn
%      gets called.  An 
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SCAPE_simpleGalvoGUI_ODOR_V1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SCAPE_simpleGalvoGUI_ODOR_V1

% Last Modified by GUIDE v2.5 11-Jun-2018 14:54:58

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SCAPE_simpleGalvoGUI_ODOR_V1_OpeningFcn, ...
                   'gui_OutputFcn',  @SCAPE_simpleGalvoGUI_ODOR_V1_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SCAPE_simpleGalvoGUI_ODOR_V1 is made visible.
function SCAPE_simpleGalvoGUI_ODOR_V1_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Start serial communication with Arduino of odor delivery system
try
    handles.odordeliveryObj = serial('COM9', 'BaudRate', 115200, 'DataBits', 8, ...
        'Terminator', 'CR');
    fopen(handles.odordeliveryObj);
catch
    obj = instrfind('Name', 'Serial-COM9');
    delete(obj)
    handles.odordeliveryObj = serial('COM9', 'BaudRate', 115200, 'DataBits', 8, ...
        'Terminator', 'CR');
    fopen(handles.odordeliveryObj);
end
% fprintf(handles.odordeliveryObj, 'pos=1');
...
% Choose default command line output for SCAPE_simpleGalvoGUI_ODOR_V1
...
% UIWAIT makes SCAPE_simpleGalvoGUI_ODOR_V1 wait for user response (see UIRESUME)
% uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = SCAPE_simpleGalvoGUI_ODOR_V1_OutputFcn(hObject, eventdata, handles) 
...
% Step 6.5: Save odor delivery parameters
temp0 = get(handles.odor_type, 'String');
odoridx = get(handles.odor_type, 'Value');
info.odor_type = cell2mat(temp0(odoridx));
info.odor_inidelay = str2num(get(handles.odor_inidelay, 'String'));
info.odor_duration = str2num(get(handles.odor_duration, 'String'));
info.odor_isi = str2num(get(handles.odor_isi, 'String'));
info.odor_rep = str2num(get(handles.odor_rep, 'String'));
info.odor_seq = str2num(get(handles.odor_seq, 'String'));
...
handles.framerateChanged = addlistener(handles.frameRateFile,'Changed', ...
    @(hObject,eventdata)SCAPE_simpleGalvoGUI_ODOR_V1('frame_rate_changed',hObject,eventdata,handles));
...
voltPower = laserPower*0.0323-0.0176;
...
% --- Executes on selection change in odor_type.
function odor_type_Callback(hObject, eventdata, handles)
% hObject    handle to odor_type (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns odor_type contents as cell array
%        contents{get(hObject,'Value')} returns selected item from odor_type


% --- Executes during object creation, after setting all properties.
function odor_type_CreateFcn(hObject, eventdata, handles)
% hObject    handle to odor_type (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in odor_update.
function odor_update_Callback(hObject, eventdata, handles)
% hObject    handle to odor_update (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.odortype = get(handles.odor_type, 'Value');
handles.odorinidelay = str2num(get(handles.odor_inidelay, 'String'));
handles.odorduration = str2num(get(handles.odor_duration, 'String'));
handles.odorisi = str2num(get(handles.odor_isi, 'String'));
handles.odorrep = str2num(get(handles.odor_rep, 'String'));
handles.traillength =  ceil(str2num(get(handles.scan_length, 'String')));
handles.odorseq = (get(handles.odor_seq, 'String'));
odorcmd = [num2str(handles.odortype) '#' num2str(handles.odorinidelay) ...
    '#' num2str(handles.odorduration) '#' num2str(handles.odorisi) ...
    '#' num2str(handles.odorrep) '#' num2str(handles.traillength) '#' (handles.odorseq) '#']
fprintf(handles.odordeliveryObj, odorcmd);

feedback = fscanf(handles.odordeliveryObj,'%f');
disp(feedback);
feedback = fscanf(handles.odordeliveryObj,'%f');
disp(feedback);
feedback = fscanf(handles.odordeliveryObj,'%f');
...
function odor_inidelay_Callback(hObject, eventdata, handles)
% hObject    handle to odor_inidelay (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of odor_inidelay as text
%        str2double(get(hObject,'String')) returns contents of odor_inidelay as a double


% --- Executes during object creation, after setting all properties.
function odor_inidelay_CreateFcn(hObject, eventdata, handles)
% hObject    handle to odor_inidelay (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function odor_duration_Callback(hObject, eventdata, handles)
% hObject    handle to odor_duration (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of odor_duration as text
%        str2double(get(hObject,'String')) returns contents of odor_duration as a double


% --- Executes during object creation, after setting all properties.
function odor_duration_CreateFcn(hObject, eventdata, handles)
% hObject    handle to odor_duration (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function odor_isi_Callback(hObject, eventdata, handles)
% hObject    handle to odor_isi (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of odor_isi as text
%        str2double(get(hObject,'String')) returns contents of odor_isi as a double


% --- Executes during object creation, after setting all properties.
function odor_isi_CreateFcn(hObject, eventdata, handles)
% hObject    handle to odor_isi (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function odor_rep_Callback(hObject, eventdata, handles)
% hObject    handle to odor_rep (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of odor_rep as text
%        str2double(get(hObject,'String')) returns contents of odor_rep as a double


% --- Executes during object creation, after setting all properties.
function odor_rep_CreateFcn(hObject, eventdata, handles)
% hObject    handle to odor_rep (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function odor_seq_Callback(hObject, eventdata, handles)
% hObject    handle to odor_seq (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of odor_seq as text
%        str2double(get(hObject,'String')) returns contents of odor_seq as a double


% --- Executes during object creation, after setting all properties.
function odor_seq_CreateFcn(hObject, eventdata, handles)
% hObject    handle to odor_seq (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
delete(handles.odordeliveryObj);
delete(hObject);
