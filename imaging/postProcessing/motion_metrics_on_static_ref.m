function [cY,mY,ng] = motion_metrics_on_static_ref(Y,ref_img,bnd,batch_size,var_name)

% computes several metrics for the quantitative assessment of the registration
% copied from Normcorre: https://github.com/flatironinstitute/NoRMCorre
% authors: Pnevmatikakis, Eftychios A and Giovannucci, Andrea
...
if nargin == 1; ref_img=[]; end
if nargin < 3; bnd = zeros(6,1); end
if nargin < 4|| isempty(batch_size); batch_size = 1000; end
