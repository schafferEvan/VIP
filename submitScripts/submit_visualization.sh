...
# if making a video of sparse lines, toggle below
# $matlabPath -nodisplay -nodesktop -r "cd('../visualization/'); make_quickMovie_twoColor $parentdir $dataDir $saveDir; exit"
...
# if making a video of sparse lines, toggle below
$matlabPath -nodisplay -nodesktop -r "cd('../visualization/'); make_rawScaled_movies_twoColor $parentdir $dataDir $saveDir; exit"
